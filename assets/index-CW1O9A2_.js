...
var l = o((e) => {
  ...
  h = o((e) => {
    ...
    function xe(e) {
      (k.current === e && (D(he), D(k)),
        _e.current === e && (D(_e), (Qf._currentValue = de)));
    }
    var Se, Ce;
    function we(e) {
      if (Se === void 0)
...
` +
    ...
    function Ei(e, t) {
      if (typeof e == `object` && e) {
        var n = Ti.get(e);
        return n === void 0
          ? ((t = { value: e, source: t, stack: Oe(t) }), Ti.set(e, t), t)
          : n;
      }
...
`,
  ...
  y = `modulepreload`,
  b = function (e) {
    return `/dietary-exchange-antigravity/` + e;
  },
  x = {},
  ee = function (e, t, n) {
  ...
  async function f() {
    if (`serviceWorker` in navigator) {
      if (
        ((c = await ee(async () => {
          let { Workbox: e } = await import(
            `./workbox-window.prod.es5-Cch4wiA5.js`
          );
          return { Workbox: e };
        }, [])
          .then(
            ({ Workbox: e }) =>
              new e(`/dietary-exchange-antigravity/sw.js`, {
                scope: `/dietary-exchange-antigravity/`,
                type: `classic`,
              }),
          )
          .catch((e) => {
      ...
      c.register({ immediate: t })
        .then((e) => {
          o ? o(`/dietary-exchange-antigravity/sw.js`, e) : a?.(e);
        })
        .catch((e) => {
          s?.(e);
        });
...
var w = (...e) =>
    e
      ...
      .join(` `)
      .trim(),
  ie = (e) => e.replace(/([a-z0-9])([A-Z])/g, `$1-$2`).toLowerCase(),
  ae = (e) =>
  ...
  pe = E(`minus`, [[`path`, { d: `M5 12h14`, key: `1ays0h` }]]),
  me = E(`plus`, [
  ...
  ge = {
    ...
    fat: { min: 7, max: 9, label: `Fat`, color: `cat-fat`, badge: `b-fat` },
    milk: {
      min: 2,
      max: 2,
      label: `Milk (Low-fat)`,
  ...
  _e = [`Breakfast`, `Lunch`, `Dinner`, `Snack`],
  ve = { starch: 0, protein: 0, vegetable: 0, fruit: 0, fat: 0, milk: 0 };
function ye() {
  let [e, t] = (0, _.useState)(() => {
      let logs = localStorage.getItem(`mealPlanLogs`);
      return logs ? JSON.parse(logs) : [];
    }),
    [displayDate, setDisplayDate] = (0, _.useState)(
      () => new Date().toISOString().split("T")[0],
    ),
    [n, r] = (0, _.useState)(``),
    [i, a] = (0, _.useState)(`Breakfast`),
    [o, s] = (0, _.useState)({ ...ve }),
    [c, l] = (0, _.useState)({ carbs: ``, protein: ``, fat: `` });

  // Filtered logs
  let displayedLogs = e.filter(
    (log) => log.timestamp.split("T")[0] === displayDate,
  );

  (0, _.useEffect)(() => {
    localStorage.setItem(`mealPlanLogs`, JSON.stringify(e));
  }, [e]);
  let u = (e) => {
      e.preventDefault();
      let t = parseFloat(c.carbs) || 0,
        n = parseFloat(c.protein) || 0,
        r = parseFloat(c.fat) || 0,
        i = Math.round(t / 15),
        a = Math.round(n / 7),
        u = Math.round(r / 5);
      (s({
    ...
    d = (a) => {
      a.preventDefault();
      let c = Object.values(o).reduce((val, val2) => val + val2, 0);
      if (!n || c === 0) return;
      t([
        {
    ...
    p = Object.keys(ge).reduce(
      (acc, key) => (
        (acc[key] = displayedLogs.reduce(
          (sum, log) => sum + (log.exchanges[key] || 0),
          0,
        )),
        acc
      ),
    ...
    exportData = () => {
      ...
      downloadAnchorNode.setAttribute("download", "meal_plan_logs.json");
      document.body.appendChild(downloadAnchorNode); // required for firefox
      downloadAnchorNode.click();
      downloadAnchorNode.remove();
    },
    m = (e, t) => {
      s((n) => ({ ...n, [e]: Math.max(0, n[e] + t) }));
    };
  return (0, k.jsxs)(`div`, {
      ...
      (0, k.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, k.jsx)(`div`, {
            ...
            children: Object.entries(ge).map(([e, t]) => {
              let n = p[e],
                r = t.max,
                i = Math.min(100, (n / r) * 100),
                a = (t.min / r) * 100;
              return (0, k.jsxs)(
                `div`,
                {
                  className: `progress-item ${t.color}`,
                  children: [
                    (0, k.jsxs)(`div`, {
                      className: `progress-header`,
                      children: [
                        (0, k.jsx)(`span`, { children: t.label }),
                        (0, k.jsxs)(`span`, {
                          children: [
                            n,
                            ` / `,
        ...
        children: [
          (0, k.jsxs)(`div`, {
            ...
            children: [
              (0, k.jsxs)(`h2`, {
                ...
                children: [
                  (0, k.jsx)(O, { className: `icon`, size: 24 }),
                  `Log Food`,
                ],
              }),
              (0, k.jsx)(`div`, {
              ...
              (0, k.jsxs)(`form`, {
                ...
                children: [
                  (0, k.jsxs)(`div`, {
                    ...
                    children: [
                      (0, k.jsx)(`label`, { children: `What did you eat?` }),
                      (0, k.jsx)(`input`, {
                        type: `text`,
                  ...
                  (0, k.jsxs)(`div`, {
                    ...
                    children: [
                      (0, k.jsx)(`label`, {
                        children: `Optional: Macro Calculator (Auto-converts to Starch, Protein, Fat)`,
                      }),
                      (0, k.jsxs)(`div`, {
                        className: `macro-calc-row`,
                        children: [
                          (0, k.jsxs)(`div`, {
                            className: `macro-input-wrapper`,
                            children: [
                              (0, k.jsx)(`input`, {
                                type: `number`,
                                min: `0`,
                  ...
                  (0, k.jsxs)(`div`, {
                    className: `input-group`,
                    children: [
                      (0, k.jsx)(`label`, { children: `Servings (Exchanges)` }),
                      (0, k.jsx)(`div`, {
                        className: `servings-grid`,
                        children: Object.entries(ge).map(([e, t]) =>
                          (0, k.jsxs)(
                            `div`,
                            {
                              className: `serving-stepper`,
                              children: [
                                (0, k.jsx)(`span`, {
                                  className: `label`,
                                  children: t.label,
                  ...
                  (0, k.jsxs)(`button`, {
                    ...
                    children: [(0, k.jsx)(fe, { size: 20 }), `Save to `, i],
                  }),
                ],
              }),
            ],
          ...
          (0, k.jsxs)(`div`, {
            ...
            children: [
              ...
              _e.map((t) => {
                let n = displayedLogs.filter((log) => log.meal === t);
                return n.length === 0
                  ? null
                  : (0, k.jsxs)(
                      `div`,
                      {
                        ...
                        children: [
                          (0, k.jsx)(`div`, {
                            className: `meal-log-header`,
                            children: (0, k.jsx)(`h3`, { children: t }),
                          }),
                          (0, k.jsx)(`div`, {
                            className: `log-list`,
                            children: n.map((e) =>
                                ...
                                `div`,
                                {
                                  ...
                                  children: [
                                    (0, k.jsxs)(`div`, {
                                      className: `log-info`,
                                      children: [
                                        (0, k.jsx)(`h4`, { children: e.name }),
                                        (0, k.jsx)(`div`, {
                                          className: `log-exchanges`,
...
(re({ immediate: !0 }),
  (0, v.createRoot)(document.getElementById(`root`)).render(
    (0, k.jsx)(_.StrictMode, { children: (0, k.jsx)(ye, {}) }),
  ));
